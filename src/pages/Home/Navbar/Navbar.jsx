    ...
    <div className="bg-neutral-800 lg:text-white bg-opacity-80 flex place-content-center py-1">
      <div className="navbar w-[90%] mx-auto ">
        ...
        <div className="navbar-end gap-1">
          <a className="btn btn-outline btn-sm text-white rounded-3xl mr-3 hover:border-blue-500" href="https://drive.google.com/uc?id=1II0-6LZC0nkZdNBaCS6KgbHaKtEPVHPX&export=download"download>Resume
