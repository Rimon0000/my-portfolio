...
const Contact = () => {
  ...
  const handleContact = (event) =>{
    ...
    fetch('http://localhost:5000/api/create-contact',{
        method: 'POST',
        headers:{
    ...
    return (
          <div className='my-20 w-[90%] mx-auto bg-base-200 rounded-lg pb-5' id='contact' data-aos="fade-up" data-aos-duration="2000" data-aos-easing="ease-out-cubic">
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5 px-10'>
                ...
                <div className="form-control">
                  ...
                  <input type="text" name='name' placeholder="Name" className="input input-bordered bg-white text-black rounded-lg" required/>
                </div>
                <div className="form-control">
                  <label className="label">
                    <span className="label-text font-bold mt-2">Email</span>
                  </label>
                  <input type="email" name='email' placeholder="Email" className="input input-bordered bg-white text-black rounded-lg" required/>
                </div>
                <div className="form-control">
                  <label className="label">
                    <span className="label-text font-bold mt-2">Message</span>
                  </label>
                  <textarea name='message' className="textarea textarea-bordered h-24 bg-white text-black rounded-lg" placeholder="Write Your Message" required></textarea>
                </div>
                <div className="pb-3 mt-3">
                  <button className="btn btn-outline btn-primary" type="submit">Contact</button>
                </div>
                </form>
                </div>
